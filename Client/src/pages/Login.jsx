    ...
    <div className='min-h-screen flex flex-col md:flex-row'>
        ...
        <div className='flex flex-col flex-1 items-start justify-between p-6 md:p-10 lg:pl-40'>
            ...
            <div>
                ...
                <h1 className='text-3xl md:text-6xl md:pb-2 font-bold bg-gradient-to-r from-indigo-950 to-indigo-800 bg-clip-text text-transparent'>More then just friends truly connect</h1>
                <p className='text-xl md:text-3xl text-indigo-900 max-w-2-72 md:max-w-md'>connect with global community on pingup</p>
